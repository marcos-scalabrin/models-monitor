...
| S-09 | Busca por nome ou ID filtra a tabela e os pontos elegíveis do mapa; limpar restaura ambos | Ensaio headless | Journal MODELS-14: busca exata reduz ambos para o mesmo modelo |
